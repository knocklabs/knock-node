...
describe('resource schedules', () => {
  test('create: only required params', async () => {
    const responsePromise = client.schedules.create({ recipients: ['user_123'], workflow: 'comment-created' });
  ...
  test('update: only required params', async () => {
    const responsePromise = client.schedules.update({ schedule_ids: ['123e4567-e89b-12d3-a456-426614174000'] });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('delete: only required params', async () => {
    const responsePromise = client.schedules.delete({ schedule_ids: ['123e4567-e89b-12d3-a456-426614174000'] });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('delete: required and optional params', async () => {
    const response = await client.schedules.delete({ schedule_ids: ['123e4567-e89b-12d3-a456-426614174000'] });
  });
});
