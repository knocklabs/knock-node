...
export class Bulk extends APIResource {
  ...
  addSubscriptions(
    ...
    return this._client.post(`/v1/objects/${collection}/bulk/subscriptions/add`, { body, ...options });
  }
  ...
  set(
    ...
    body: BulkSetParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<BulkSetResponse> {
    return this._client.post(`/v1/objects/${collection}/bulk/set`, { body, ...options });
  }
}
