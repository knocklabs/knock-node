...
export class Schedules extends APIResource {
   ...
   * Create schedules
   */
  create(body: ScheduleCreateParams, options?: Core.RequestOptions): Core.APIPromise<ScheduleCreateResponse> {
   ...
   * Update schedules
   */
  update(body: ScheduleUpdateParams, options?: Core.RequestOptions): Core.APIPromise<ScheduleUpdateResponse> {
   ...
   * Delete schedules
   */
  delete(body: ScheduleDeleteParams, options?: Core.RequestOptions): Core.APIPromise<ScheduleDeleteResponse> {
