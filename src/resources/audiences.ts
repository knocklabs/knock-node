...
export class Audiences extends APIResource {
  ...
  addMembers(
    key: string,
    body: AudienceAddMembersParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<string> {
    return this._client.post(`/v1/audiences/${key}/members`, { body, ...options });
  }
  ...
  removeMembers(
    ...
    return this._client.delete(`/v1/audiences/${key}/members`, { body, ...options });
  }
}
