...
export class Bulk extends APIResource {
  ...
  delete(params: BulkDeleteParams, options?: Core.RequestOptions): Core.APIPromise<BulkDeleteResponse> {
    const { user_ids1, ...body } = params;
    return this._client.post('/v1/users/bulk/delete', { query: { user_ids: user_ids1 }, body, ...options });
  }

  /**
   * Bulk identifies users
   */
  identify(body: BulkIdentifyParams, options?: Core.RequestOptions): Core.APIPromise<BulkIdentifyResponse> {
  ...
  ): Core.APIPromise<BulkSetPreferencesResponse> {
